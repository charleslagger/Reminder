...
public class AlarmListAdapter extends BaseAdapter {
	...
	public View getView(int position, View view, ViewGroup viewGroup) {
		...
		TextView alarmLocView = (TextView) view
				.findViewById(R.id.textView_alarm_local);
		alarmLocView.setText(alarm.getAlarmLoc());


		TextView alarmTitleView = (TextView) view
				.findViewById(R.id.textView_alarm_title);
		alarmTitleView.setText(alarm.getAlarmName());
