package com.embeddedlog.LightUpDroid.database;
...
import com.embeddedlog.LightUpDroid.Alarm.Difficulty;
...
public class Database extends SQLiteOpenHelper {
	...
	public static final String COLUMN_ALARM_LOC = "alarm_loc";
	...
	public static final String COLUMN_ALARM_NOTE = "alarm_note";
	...
	public static long create(Alarm alarm) {
		...
		cv.put(COLUMN_ALARM_LOC, alarm.getAlarmLoc());
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL("CREATE TABLE IF NOT EXISTS " + ALARM_TABLE + " ( "
				...
				+ COLUMN_ALARM_LOC + " TEXT NOT NULL, "
	...
	public static List<Alarm> getAll() {
		...
		if (cursor.moveToLast()) {
			do {
				...
				alarm.setAlarmLoc(cursor.getString(7));
